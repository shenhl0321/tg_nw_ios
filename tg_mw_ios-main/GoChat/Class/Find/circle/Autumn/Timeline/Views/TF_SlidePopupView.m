...
@interface TF_SlidePopupView()<UIGestureRecognizerDelegate>
...
@implementation TF_SlidePopupView

+ (instancetype)popupViewWithFrame:(CGRect)frame contentView:(UIView *)contentView {
    return [[TF_SlidePopupView alloc] initWithFrame:frame contentView:contentView];
}
