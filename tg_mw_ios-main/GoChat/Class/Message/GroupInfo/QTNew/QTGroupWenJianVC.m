...
@implementation QTGroupWenJianVC
...
- (void)viewDidLoad
{
    ...
    //先同步会话信息
    [self syncChatInfo];
    [self.customNavBar setTitle:@"群组文件".lv_localized];
    [self resetBaseInfo];
...
//            return 230;
        ...
        case 2:
        {
//            return [CZCommonTool getCellHeightWithStr:[self resetNoticeInfo] withbool:self.isShowAll] + 10;
            return 74.5 + 10 + 10;
        }
            break;
        case 3:
