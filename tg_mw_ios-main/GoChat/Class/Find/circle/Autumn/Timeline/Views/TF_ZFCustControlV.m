...
@interface TF_ZFCustControlV () <ZFSliderViewDelegate>
...
@implementation TF_ZFCustControlV
...
- (void)makeSubViewsAction {
    ...
    [self.backBtn addTarget:self action:@selector(fullScreenButtonClickAction:) forControlEvents:UIControlEventTouchUpInside];
}
...
- (void)layoutSubviews {
    ...
    self.backBtn.frame = CGRectMake(min_x, min_w, 40, 40);
    self.backBtn.zf_centerY = self.topToolView.zf_centerY;
    
    self.titleLabel.frame = CGRectMake(min_x + 50, min_y, min_w, min_h);
