...
@interface CZGroupFirTableViewCell ()
...
@implementation CZGroupFirTableViewCell
...
- (void)setMembersList:(NSArray *)membersList{
    if (membersList) {
        ...
        _groupMemberCountLabel.text = [NSString stringWithFormat:@"共%ld人,%ld人在线".lv_localized,self.membersList.count,onlineNumber];
    }
}
...
- (void)awakeFromNib {
    ...
    self.groupMemberCountLabel.hidden = !config.shown_online_members;
}
