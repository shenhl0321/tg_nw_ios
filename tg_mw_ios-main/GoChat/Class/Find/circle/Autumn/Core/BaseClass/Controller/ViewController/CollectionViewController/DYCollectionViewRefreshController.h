//
//  DYCollectionViewRefreshController.h
//  FirePlatform
//
...
FOUNDATION_EXTERN NSString *const kCollectionCurrentPageValue;

@interface DYCollectionViewRefreshController : DYCollectionViewController
