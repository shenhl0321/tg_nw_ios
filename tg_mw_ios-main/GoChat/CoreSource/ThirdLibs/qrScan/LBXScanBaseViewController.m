...
#pragma mark- 识别结果
- (void)scanResultWithArray:(NSArray<LBXScanResult*>*)array isChooseImage:(BOOL)isChooseImage
{
...
- (void)showNextVCWithScanResult:(LBXScanResult*)strResult
{
    ...
    else
    {
        ...
        //
        //[UserInfo showTips:nil des:strResult.strScanned];
        if([self.delegate respondsToSelector:@selector(LBXScanBaseViewController_Result:)])
        {
            [self.delegate LBXScanBaseViewController_Result:strResult.strScanned];
        }
    }
}
