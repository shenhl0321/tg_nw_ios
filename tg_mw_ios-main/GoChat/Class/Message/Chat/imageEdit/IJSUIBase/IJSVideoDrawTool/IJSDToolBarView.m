...
- (void)_createdUI
{
    ...
    UIBarButtonItem *cleanAll = [[UIBarButtonItem alloc] initWithTitle:[NSString stringWithFormat:@"%@", @"清屏".lv_localized] style:UIBarButtonItemStylePlain target:self action:@selector(cleanAllAction:)];

    UIBarButtonItem *cleanLast = [[UIBarButtonItem alloc] initWithTitle:[NSString stringWithFormat:@"%@", @"撤销".lv_localized] style:UIBarButtonItemStylePlain target:self action:@selector(cleanLastAction:)];
