...
- (void)displayImage:(UIImage *)image {
    ...
    UISwipeGestureRecognizer *customSwipTap = [[UISwipeGestureRecognizer alloc]initWithTarget:self action:@selector(handleSwipeFrom:)];
    [customSwipTap setDirection:(UISwipeGestureRecognizerDirectionDown)];
...
//
    ...
    [self.imageView addGestureRecognizer:customSwipTap];
...
- (void)handleSwipeFrom:(UIGestureRecognizer *)gestureRecognizer{
    if (self.photoViewDelegate != nil && [self.photoViewDelegate respondsToSelector:@selector(handleSwipeFrom:)])
    {
        [self.photoViewDelegate handleSwipeFrom:self];
    }
}
...
- (void)handleLongPress:(UILongPressGestureRecognizer *)gestureRecognizer
{
    ...
    {
        if (self.photoViewDelegate != nil && [self.photoViewDelegate respondsToSelector:@selector(photoViewDidLongSingleTap:)])
        {
            [self.photoViewDelegate photoViewDidLongSingleTap:self];
        }
    }
}
