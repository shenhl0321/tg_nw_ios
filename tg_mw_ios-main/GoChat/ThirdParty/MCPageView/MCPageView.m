...
{
    if (!_lineView) {
        _lineView = [[UIView alloc]initWithFrame:CGRectMake(_titleButtonWidth/4, self.titleScrollHeight - 1, _titleButtonWidth/2, 2)];
...
- (void)setTitleBackgroundColor:(UIColor *)titleBackgroundColor{
    ...
    self.titleScroll.backgroundColor = titleBackgroundColor;
}
@end
