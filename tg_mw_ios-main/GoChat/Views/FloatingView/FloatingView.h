...
/**
 点击的回调block
 */
@property (nonatomic,copy) void(^clickDragViewBlock)(FloatingView *dragView);
/**
 开始拖动的回调block
 */
@property (nonatomic,copy) void(^beginDragBlock)(FloatingView *dragView);
/**
 拖动中的回调block
 */
@property (nonatomic,copy) void(^duringDragBlock)(FloatingView *dragView);
/**
 结束拖动的回调block
 */
@property (nonatomic,copy) void(^endDragBlock)(FloatingView *dragView);
@end
