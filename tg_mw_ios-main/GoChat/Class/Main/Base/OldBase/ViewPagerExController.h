...
/**
 * Main parts of the ViewPagerExController
 *
...
@interface ViewPagerExController : BaseViewController
 ...
 *
 * @param option The option key. Keys are defined in ViewPagerExController.h
 *
 ...
 *
 * @param component The component key. Keys are defined in ViewPagerExController.h
 *
 ...
 */
- (NSUInteger)numberOfTabsForViewPager:(ViewPagerExController *)viewPager;
/**
 ...
 */
- (UIView *)viewPager:(ViewPagerExController *)viewPager viewForTabAtIndex:(NSUInteger)index;
 ...
 */
- (UIViewController *)viewPager:(ViewPagerExController *)viewPager contentViewControllerForTabAtIndex:(NSUInteger)index;
/**
 ...
 */
- (UIView *)viewPager:(ViewPagerExController *)viewPager contentViewForTabAtIndex:(NSUInteger)index;
 ...
 */
- (void)viewPager:(ViewPagerExController *)viewPager didChangeTabToIndex:(NSUInteger)index;
/**
 ...
 */
- (void)viewPager:(ViewPagerExController *)viewPager didChangeTabToIndex:(NSUInteger)index fromIndex:(NSUInteger)previousIndex;
/**
 ...
 */
- (void)viewPager:(ViewPagerExController *)viewPager didChangeTabToIndex:(NSUInteger)index fromIndex:(NSUInteger)previousIndex didSwipe:(BOOL)didSwipe;
/**
 ...
 * @return A CGFloat, defining the setting for the given option
 */
- (CGFloat)viewPager:(ViewPagerExController *)viewPager valueForOption:(ViewPagerOption)option withDefault:(CGFloat)value;
 ...
 * @return A UIColor for the given component
 */
- (UIColor *)viewPager:(ViewPagerExController *)viewPager colorForComponent:(ViewPagerComponent)component withDefault:(UIColor *)color;

- (void)viewPagerWithTabsViewFrameChange:(CGRect)frame;
@end
