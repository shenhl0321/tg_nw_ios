//
//  CreateP2pRedPacketViewController.m
//  GoChat
//
...
@interface CreateP2pRedPacketViewController ()<GotWpPasswordDialogDelegate>
...
@implementation CreateP2pRedPacketViewController
...
//    self.customNavBar.frame = CGRectMake(0, -APP_STATUS_BAR_HEIGHT, APP_SCREEN_WIDTH, 88);
    ...
    //背景
    self.view.backgroundColor = HEX_COLOR(@"#f2f2f2");
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.row == 3)
    {
        ...
        return SCREEN_HEIGHT-top-75.0f-100.0f-100.0f-40.0f;
    }
