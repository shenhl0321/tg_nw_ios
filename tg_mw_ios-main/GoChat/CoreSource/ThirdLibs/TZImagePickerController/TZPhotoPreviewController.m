...
- (void)configBottomToolBar {
    ...
    [_editBtn setTitle:@"编辑".lv_localized forState:UIControlStateNormal];
    ...
    [_toolBar addSubview:_editBtn];
    [self.view addSubview:_toolBar];
    
    if (_tzImagePickerVc.photoPreviewPageUIConfigBlock) {
        _tzImagePickerVc.photoPreviewPageUIConfigBlock(_collectionView, _naviBar, _backButton, _selectButton, _indexLabel, _toolBar, _originalPhotoButton, _originalPhotoLabel, _doneButton, _numberImageView, _numberLabel,_editBtn);
    }
}
...
- (void)viewDidLayoutSubviews {
    ...
    [_editBtn sizeToFit];
    _editBtn.frame = CGRectMake(CGRectGetMaxX(_originalPhotoLabel.frame), 0, MAX(44, _doneButton.tz_width), 44);
    
    [self configCropView];
    
    if (_tzImagePickerVc.photoPreviewPageDidLayoutSubviewsBlock) {
        _tzImagePickerVc.photoPreviewPageDidLayoutSubviewsBlock(_collectionView, _naviBar, _backButton, _selectButton, _indexLabel, _toolBar, _originalPhotoButton, _originalPhotoLabel, _doneButton, _numberImageView, _numberLabel,_editBtn);
    }
}
...
-(void)showImage:(UIImage *)photo{
    IJSImageManagerController *vc = [[IJSImageManagerController alloc]initWithEditImage:photo];
...
//            self.editButtonClickBlock(image);
//        }
    }];
