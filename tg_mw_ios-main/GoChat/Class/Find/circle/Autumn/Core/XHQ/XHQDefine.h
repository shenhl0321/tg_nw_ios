...
/** 状态栏高度 */
static inline CGFloat kStatusBarHeights() {
    return [[UIApplication sharedApplication] statusBarFrame].size.height;
}

/** 导航栏+状态栏高度 */
static inline CGFloat kNavigationStatusHeight() {
    return (kStatusBarHeights() + kNavigationBarHeight());
}
...
/** 底部标签栏高度 */
static inline CGFloat kTabBarHeights() {
...
/** 防止金额丢失精度 */
static inline NSString *kMoneyValue(NSString *money) {
