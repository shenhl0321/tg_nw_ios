...
#define IJSMapViewMapItemW (JSScreenWidth - 5 * IJSMapViewMapItemMarginLeft) / 8 //item 宽度
#define IJSMapViewMapItemH (IJSMapViewMapH - 3 * IJSMapViewMapItemMarginTop) / 4 //item 高度
